...
const Sidebar = () => {
    return (
        <div className='w-[224px] h-screen bg-[#1E2640] flex flex-col'>
            ...
            <div className='w-[208px] mx-auto flex flex-col justify-center gap-[16px] mt-[24px]'>
            ...
            <div className='w-[192px] h-[54px] bg-[#353C53] rounded-[4px] flex flex-row gap-[12px] items-center px-[12px] py-[6px] relative mb-[16px]'>
