...
const Sidebar = () => {
    return (
        <div className='w-[224px] h-[748px] bg-[#1E2640] flex flex-col justify-between sticky inset-0' style={{zIndex: "9999px"}}>
            ...
            <div className='flex flex-row pl-[16px] pt-[16px]'>
                <div className='flex flex-row gap-[12px]'>
                    ...
                    <div className='flex flex-col gap-[4px] text-[#FFF] font-Inter'>
                        ...
                        <a className='text-[13px] font-normal opacity-[0.8] underline'>Visit store</a>
                    </div>
                </div>
            ...
            <div className='w-[208px] ml-[16px] flex flex-col gap-[16px] mt-[24px]'>
                {SideBarList.map((item, index) => (
                    <div key={index} className='flex flex-row gap-[12px] text-[#FFF] text-[14px] font-Inter font-medium'>
                        <item.icon />
            ...
            <div className='w-[192px] h-[54px] bg-[#353C53] rounded-[4px] flex flex-row gap-[12px] items-center px-[12px] py-[6px] mx-auto mb-[16px]'>
                ...
                <div className='flex flex-col gap-[2px] items-center font-Inter text-[#FFF] opacity-[0.8] mb-[16px] mt-auto'>
