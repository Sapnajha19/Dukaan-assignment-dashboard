            ...
            <div className='w-full bg-[#FAFAFA] flex flex-col'>
                ...
                <div className='flex flex-col ml-[32px] mr-[32px] mt-[36px] font-Inter'>
                    <div className='flex flex-row justify-between items-center'>
                        ...
                        <div className='w-[137px] h-[36px] flex flex-row gap-[7px] justify-center items-center rounded-[4px] bg-[#FFF] border border-[1px] border-[#D9D9D9]'>
                    ...
                    <div className='flex flex-row gap-[20px] mt-[24px]'>
                        {StatisticsData.map((item) => (
                            <div className='w-[566px] h-[118px] bg-[#FFF] shadow-[0px_2px_6px_0px_rgba(26,24,30,0.04)] rounded-[8px] flex flex-col gap-[16px] pl-[20px] pt-[20px]'>
